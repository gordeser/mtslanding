...
const Tariffone = () => {
    ...
    const [tariffName, setTariffName] = useState('Тариф №1')
    ...
    return (
        <div className="App">
            <div className="container">
                ...
                <Tabs indicatorColor="primary" textColor="primary" centered sx={{
                    '& .MuiTabs-flexContainer': {
                        flexWrap: 'wrap',
                    },
                }}>
                    <Tab label="МТС Новогодний+" component={Link} to="/newyearplus" sx={{fontFamily: "MTSCompact, sans-serif", fontSize: "17px"}} />
                    <Tab label="Тариф №1" component={Link} to="/tariff_1" sx={{color: "#ff0032", fontFamily: "MTSCompact, sans-serif", fontSize: "17px"}} />
                    <Tab label="Тариф №3" component={Link} to="/tariff_3" sx={{fontFamily: "MTSCompact, sans-serif", fontSize: "17px"}} />
                </Tabs>

                <div className="image" style={{backgroundImage: "url('//static.mts.ru/dpc_upload/contents/614/tarif_1_1920x947_2x.avif')"}}>
                    <div className="white-rectangle">
                        ...
                        <div className="inside-content">
                            ...
                            <div className="short-description">
                                Тариф с мобильной связью, домашним интернетом, ТВ и онлайн-кинотеатром KION
                            </div>
                            ...
                            <div className="params">
                                ...
                                <div className="minutes">
                                    <img src="//static.mts.ru/dpc_upload/contents/354/icon_card_min.svg" className="phone" />
                                    500 минут
                                </div>
                            ...
                            <div className="price-container">
                                <div className="price">
                                    <div className="price-value" style={{marginTop: "5px", marginLeft: "2px"}}>{sliderValue === 0 ? 700 : 1100 }</div>
                                    <div className="price-measure">₽/мес</div>
                                    <div className="old-price" style={{marginLeft: "20px"}}>{sliderValue === 0 ? 850 : 750 } ₽</div>
                                </div>
                            </div>

                            <span className="price-description">
                                {sliderValue === 0 ? "Стоимость 2го и 3го месяца, с 4 месяца — 850 ₽/мес" : ""}
                            </span>
