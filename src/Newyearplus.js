    ...
    return (
        <div className="App">
            <div className="container">
                <Tabs textColor="primary" centered sx={{
                    '& .MuiTabs-flexContainer': {
                        flexWrap: 'wrap',
                    },
                }}>
                    <Tab label="МТС Новогодний+" component={Link} to="/newyearplus" sx={{color: "#ff0032", fontFamily: "MTSCompact, sans-serif", fontSize: "17px"}} />
                ...
                <div className="image" style={{backgroundImage: "url('//static.mts.ru/dpc_upload/contents/614/mts_novogodnij_3840_1894.avif')"}}>
                        ...
                        <div className="inside-content">
                            ...
                            <div className="price-container">
                                <div className="price">
                                    ...
                                    <div className="old-price" style={{marginLeft: "20px"}}>{sliderValue === 0 ? 850 : 1090 } ₽</div>
                                </div>
                            </div>

                            <span className="price-description">
                                Стоимость по акции первые 12 месяцев, с 13 месяца — {sliderValue === 0 ? 850 : 1090 } ₽/мес
                            </span>
